...
(function () {
  ...
  const outputLines = [
    ...
    { text: '  → masterclaw    ✓ running', cls: 'accent' },
    { text: '', cls: '' },
    { text: '🐙 Stack deployed!', cls: 'success' },
    { text: '  OpenClaw gateway: http://localhost:18789', cls: 'success' },
    { text: '  MasterClaw API:   http://localhost:8090', cls: 'success' },
  ];
